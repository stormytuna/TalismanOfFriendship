...
namespace TalismanOfFriendship.Helpers;

public static class TooltipHelpers
{
	public static void InsertTooltips(this List<TooltipLine> tooltips, IEnumerable<TooltipLine> tooltipsToInsert, string insertAfter) {
	...
	public static void InsertTooltip(this List<TooltipLine> tooltips, TooltipLine tooltipToInsert, string insertAfter) => InsertTooltips(tooltips, new List<TooltipLine>() {
		tooltipToInsert
	}, insertAfter);
